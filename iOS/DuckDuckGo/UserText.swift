...
public struct UserText {
    ...
    public static let actionSendInternalFeedback = NSLocalizedString("action.title.sendInternalFeedback", value: "Send Internal Feedback", comment: "Open the internal feedback form action")
