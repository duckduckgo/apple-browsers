...
final class AIChatSidebarPresenterTests: XCTestCase {
    ...
    private var mockWindowControllersManager: MockWindowControllersManager!
    ...
    override func setUp() {
        ...
        mockWindowControllersManager = MockWindowControllersManager()
...
//        // Given
//        mockFeatureFlagger.enabledFeatureFlags = []
//        let prompt = AIChatNativePrompt(text: "Test prompt", fromPixel: nil)
//        let initialCount = mockSidebarProvider.sidebarsByTab.count
//
//        // When
...
//    }
    ...
    func testSidebarHostDidUpdateTabs_cleansUpProvider() {
        // Given
        mockSidebarProvider.makeSidebar(for: "tab1", burnerMode: .regular)
        mockSidebarProvider.makeSidebar(for: "tab2", burnerMode: .regular)
...
//        XCTAssertEqual(mockAIChatTabOpener.lastPayload, payload)
//    }
...
//        let prompt = AIChatNativePrompt(text: "Test", fromPixel: nil)
//        presenter.presentSidebar(for: prompt)
//
...
class MockWindowControllersManager: WindowControllersManagerProtocol {
    ...
    func openAIChat(_ url: URL, with linkOpenBehavior: DuckDuckGo_Privacy_Browser.LinkOpenBehavior) {}
    func openAIChat(_ url: URL, with linkOpenBehavior: DuckDuckGo_Privacy_Browser.LinkOpenBehavior, hasPrompt: Bool) {}
    ...
    func windowController(for window: NSWindow) -> MainWindowController? {
        return nil
    }
