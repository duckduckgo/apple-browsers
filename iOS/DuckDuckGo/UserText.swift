...
public struct UserText {
    ...
    public static let inactivityNotificationBody = NotLocalizedString("inactivity.notification.body", value: "Over 85% of popular sites contain trackers. Search and browse with DuckDuckGo to help avoid them.", comment: "Body for inactivaity notification. Used on for en_US locale only.")
