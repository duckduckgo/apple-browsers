...
public struct UserText {
    ...
    static let netPExcludeCGNATSettingFooter = NSLocalizedString("network.protection.vpn.exclude.cgnat.setting.footer", value: "Let services like Wi-Fi calling and voicemail bypass the VPN so they keep working.", comment: "Footer text for the Exclude CGNAT setting item.")
