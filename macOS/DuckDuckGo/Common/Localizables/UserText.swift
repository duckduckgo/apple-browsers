...
struct UserText {
    ...
    static let aiChatModelPickerAvailableWithProSectionHeader = NotLocalizedString("aichat.model-picker.section.available-with-pro", value: "AVAILABLE WITH PRO", comment: "Section header above Pro-only models in the model picker")
