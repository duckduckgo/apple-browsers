...
public extension URL {
    ...
    static let aiChatAccessSubscriberModels = URL(string: AppDeepLinkSchemes.quickLink.appending("\(ddg.host!)/duckduckgo-help-pages/duckai/access-subscriber-AI-models"))!
