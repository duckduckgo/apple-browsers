...
public struct UserText {
    ...
    static let netPExcludeCGNATSettingTitle = NSLocalizedString("network.protection.vpn.exclude.cgnat.setting.title", value: "Exclude Carrier-Grade NAT", comment: "Title for the Exclude CGNAT setting item.")
    static let netPExcludeCGNATSettingFooter = NSLocalizedString("network.protection.vpn.exclude.cgnat.setting.footer", value: "Let traffic to carrier-internal addresses (100.64.0.0/10) bypass the VPN. Recommended to keep on so Wi-Fi calling, Visual Voicemail, and mesh VPNs like Tailscale keep working.", comment: "Footer text for the Exclude CGNAT setting item.")
