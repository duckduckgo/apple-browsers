//
//  RebrandedOnboardingAddressBarPositionPickerViewModel.swift
//  DuckDuckGo
//
...
final class RebrandedOnboardingAddressBarPositionPickerViewModel: ObservableObject {
    ...
    private let addressBarPositionManager: RebrandedAddressBarPositionManaging

    init(addressBarPositionManager: RebrandedAddressBarPositionManaging = AppUserDefaults()) {
...
protocol RebrandedAddressBarPositionManaging: AnyObject {
    var currentAddressBarPosition: AddressBarPosition { get set }
}

extension AppUserDefaults: RebrandedAddressBarPositionManaging {}
