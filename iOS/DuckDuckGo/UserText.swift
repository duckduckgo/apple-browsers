...
public struct UserText {
    ...
    public static let actionSummarizeWithAIChat = NSLocalizedString("action.title.aiChat.summarizeWithDuckAI", value: "Summarize with Duck.ai", comment: "Edit-menu action shown on text selected in the browser; asks Duck.ai to summarize the selection straight away")
    public static let actionTranslateWithAIChat = NSLocalizedString("action.title.aiChat.translateWithDuckAI", value: "Translate with Duck.ai", comment: "Edit-menu action shown on text selected in the browser; asks Duck.ai to translate the selection straight away")
