...
extension TabBarViewItem: NSMenuDelegate {
    ...
    private func addNewToTheRightMenuItem(to menu: NSMenu) {
        ...
        newTabMenuItem.withImageOnMacOS26(DesignSystemImages.Glyphs.Size12.tabNew)
    ...
    private func addDuplicateMenuItem(to menu: NSMenu) {
        ...
        duplicateMenuItem.withImageOnMacOS26(DesignSystemImages.Glyphs.Size12.windowDuplicate)
    ...
    private func addPinMenuItem(to menu: NSMenu) {
        ...
        pinMenuItem.withImageOnMacOS26(isPinned ? DesignSystemImages.Glyphs.Size12.pinRemove : DesignSystemImages.Glyphs.Size12.pin)
    ...
    private func addBookmarkMenuItem(to menu: NSMenu) {
        ...
        bookmarkMenuItem.withImageOnMacOS26(DesignSystemImages.Glyphs.Size12.bookmarkAdd)
    ...
    private func addFireproofMenuItem(to menu: NSMenu) {
        ...
        menuItem.withImageOnMacOS26(DesignSystemImages.Glyphs.Size12.fireproof)
    ...
    private func addMuteUnmuteMenuItem(to menu: NSMenu) {
        ...
        muteUnmuteMenuItem.withImageOnMacOS26(audioState.isMuted ? DesignSystemImages.Glyphs.Size12.audio : DesignSystemImages.Glyphs.Size12.audioMute)
    ...
    private func addCloseMenuItem(to menu: NSMenu) {
        ...
        closeMenuItem.withImageOnMacOS26(DesignSystemImages.Glyphs.Size12.close)
