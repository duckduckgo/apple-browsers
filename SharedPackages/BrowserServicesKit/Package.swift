...
// The swift-tools-version declares the minimum version of Swift required to build this package. TEMP CHANGE
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts.git", exact: "13.19.0"),
