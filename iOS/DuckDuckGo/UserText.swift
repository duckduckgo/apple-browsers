...
public struct UserText {
    ...
    public static let aiChatAttachmentPrivacyNotice = NSLocalizedString("aichat.attachment.privacy.notice", value: "Files are automatically scanned for illegal content. Flagged chats have limited data retention. Learn more", comment: "Message shown below the Duck.ai input after the user attaches a file or image, explaining that attachments are scanned. Ends with the 'Learn more' link text.")
    public static let aiChatAttachmentPrivacyNoticeLearnMore = NSLocalizedString("aichat.attachment.privacy.notice.learnMore", value: "Learn more", comment: "The link text at the end of the attachment privacy message. Must match the trailing words of aichat.attachment.privacy.notice exactly.")
