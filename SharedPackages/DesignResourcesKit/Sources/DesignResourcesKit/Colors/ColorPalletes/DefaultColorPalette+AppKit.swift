...
struct DefaultColorPalette: ColorPaletteDefinition {
    ...
    // URL Bar
    static let urlBar = DynamicColor(lightColor: .white, darkColor: Color(0x474747))

    // Backgrounds
    static let background = DynamicColor(lightHex: 0xf2f2f2, darkHex: 0x282828)
    static let backgroundTertiary = DynamicColor(lightColor: .white, darkColor: Color(0x474747))
    static let backgroundSheets = DynamicColor(lightHex: 0xf9f9f9, darkHex: 0x373737)
    static let backdrop = DynamicColor(lightHex: 0xe0e0e0, darkHex: 0x080808)
    static let backgroundBlur = DynamicColor(staticColor: .gray90.opacity(0.7))

    // System
    static let lines = DynamicColor(lightColor: Color(0x1f1f1f).opacity(0.09), darkColor: Color(0xf9f9f9).opacity(0.12))
    static let highlightDecoration = DynamicColor(lightColor: .tint(0.24), darkColor: Color(0xf9f9f9).opacity(0.12))
    ...
    static let textPlaceholder = DynamicColor(lightColor: Color(0x1f1f1f).opacity(0.4), darkColor: .tint(0.4))
