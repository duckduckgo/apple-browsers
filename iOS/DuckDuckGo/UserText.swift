...
public struct UserText {
    ...
    public static let aiChatTabSwitcherCardVoiceActive = NotLocalizedString("aiChat.tabSwitcher.card.voiceActive", value: "Active Voice Chat", comment: "Interim title shown on the Duck.ai tab grid card for a tab with a live voice session in progress. Placeholder until the dark live-voice card UI lands.")
