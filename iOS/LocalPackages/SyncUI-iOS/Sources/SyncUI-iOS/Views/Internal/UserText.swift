...
public struct UserText {
    ...
    static let simplifiedSyncCodeAppName = NotLocalizedString("sync.simplified.sync.code.app.name", bundle: Bundle.module, value: "DuckDuckGo", comment: "DuckDuckGo app name shown in the app chip on the sync-code sheet")
