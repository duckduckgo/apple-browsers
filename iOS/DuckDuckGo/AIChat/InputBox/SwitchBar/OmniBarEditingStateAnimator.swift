...
final class OmniBarEditingStateAnimator {
    ...
    var transitionYTranslation: CGFloat { transitionDelegate?.switchBarVC.segmentedPickerView?.bounds.height ?? 0 }
...
//            transitionDelegate.adjustForAppearance(yTranslation: 150)
//        }
