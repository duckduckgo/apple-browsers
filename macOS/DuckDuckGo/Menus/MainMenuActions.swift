...
extension AppDelegate {
    ...
    @MainActor
    @objc func debugInstallFirefoxExtensionByOpeningListingPage(_ sender: Any?) {
        FirefoxExtensionInstaller(installURL: FirefoxExtensionInstaller.InstallURL.listingPage).installDDGExtension()
    }
