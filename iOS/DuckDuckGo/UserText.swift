...
public struct UserText {
    ...
    public static let tabSwitcherTrackerCountSubtitle = NSLocalizedString("tab.switcher.tracker.count.subtitle", value: "last 7 days", comment: "Subtitle for tracker count banner indicating time window")
