...
struct UserText {
    ...
    static let aiChatImageUploadButtonImageGenLabel = NSLocalizedString("aichat.image-upload-button.image-gen-label", value: "Start with an image", comment: "Label for the image upload button when image generation mode is active")
    static let aiChatImageGenButtonTooltip = NSLocalizedString("aichat.image-gen-button.tooltip", value: "Generate image", comment: "Tooltip for the image generation toggle button in AI chat omnibar")
