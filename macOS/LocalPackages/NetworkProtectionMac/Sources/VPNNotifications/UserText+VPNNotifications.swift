...
final class UserText {
    ...
    static let vpnStrictRoutingReminderNotificationSubtitle = NSLocalizedString("vpn.strict.routing.reminder.notification.subtitle", value: "Some traffic may bypass the VPN on untrusted networks. Turn Strict routing on to keep all your traffic protected.", comment: "The subtitle of the notification reminding the user to turn the VPN Strict routing setting back on")
