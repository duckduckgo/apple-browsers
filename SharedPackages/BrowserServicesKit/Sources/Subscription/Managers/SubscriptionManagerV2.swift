...
public final class DefaultSubscriptionManagerV2: SubscriptionManagerV2 {
    ...
    func migrateAuthV1toAuthV2IfNeeded() async {
        do {
            ...
            _ = try? await self.getSubscription(cachePolicy: .remoteFirst)
    ...
    var cachedUserEntitlements: [SubscriptionEntitlement] {
        ...
        set {
            ...
            if !SubscriptionEntitlement.areEntitlementsEqual(currentCachedUserEntitlements, newValue) {
                ...
                let payload = EntitlementsDidChangePayload(entitlements: newValue, previousEntitlements: currentCachedUserEntitlements)
