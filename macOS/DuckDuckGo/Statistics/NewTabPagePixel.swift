...
enum NewTabPagePixel: PixelKitEvent {
    ...
    var name: String {
        ...
        case .aiChatRecentChatSelectedPinnedMouse: return "new_tab_page_aichat_recent_chat_selected_pinned_mouse"
        case .aiChatRecentChatSelectedPinnedKeyboard: return "new_tab_page_aichat_recent_chat_selected_pinned_keyboard"
        case .aiChatRecentChatSelectedMouse: return "new_tab_page_aichat_recent_chat_selected_mouse"
        case .aiChatRecentChatSelectedKeyboard: return "new_tab_page_aichat_recent_chat_selected_keyboard"
