...
""", comment: "about page")
    ...
    public static let duckPlayerYouTubeNoAdsPrivacy = NSLocalizedString("duckplayer.youtube.no.ads.privacy", value: "YouTube but with fewer ads and more privacy", comment: "Title for Duck Player welcome message highlighting privacy benefits")
