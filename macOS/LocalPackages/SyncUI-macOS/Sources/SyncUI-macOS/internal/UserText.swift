...
enum UserText {
    ...
    static let syncWithAnotherDeviceScanStep1PrefixV2 = NSLocalizedString("preferences.sync.sync-with-another-device-v2.scan-step-1-prefix", bundle: Bundle.module, value: "On your phone, open", comment: "First part of the first QR scanning instruction, before the DuckDuckGo product name (V2)")
    static let syncWithAnotherDeviceScanStep1DetailV2 = NSLocalizedString("preferences.sync.sync-with-another-device-v2.scan-step-1-detail", bundle: Bundle.module, value: "DuckDuckGo", comment: "Emphasized DuckDuckGo product name in the first QR scanning instruction (V2)")
    static let syncWithAnotherDeviceEnterStep1PrefixV2 = NSLocalizedString("preferences.sync.sync-with-another-device-v2.enter-step-1-prefix", bundle: Bundle.module, value: "Open another", comment: "First part of the first code entry instruction, before the DuckDuckGo product name (V2)")
    static let syncWithAnotherDeviceEnterStep1DetailV2 = NSLocalizedString("preferences.sync.sync-with-another-device-v2.enter-step-1-detail", bundle: Bundle.module, value: "DuckDuckGo App", comment: "Emphasized DuckDuckGo product name in the first code entry instruction (V2)")
    ...
    static let syncAuthenticationCancelledTitleV2 = NSLocalizedString("preferences.sync.authentication-cancelled-v2.title", bundle: Bundle.module, value: "Authenticate to enable Sync & Backup", comment: "Title of the alert shown when the user cancels the device authentication prompt while setting up Sync (V2)")
    static let syncAuthenticationCancelledSubtitleV2 = NSLocalizedString("preferences.sync.authentication-cancelled-v2.subtitle", bundle: Bundle.module, value: "Sync & Backup is end-to-end encrypted. macOS will ask for an authentication method.", comment: "Subtitle of the alert shown when the user cancels the device authentication prompt while setting up Sync (V2)")
