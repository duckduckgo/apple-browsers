...
final class AddressBarTextField: NSTextField {
    ...
    private func updateTabUrlWithUrl(_ providedUrl: URL, userEnteredValue: String, downloadRequested: Bool, suggestion: Suggestion?) {
        ...
        let baseURL = Application.appDelegate.subscriptionManagerV2.url(for: .baseURL)
        let identityTheftRestorationURL = Application.appDelegate.subscriptionManagerV2.url(for: .identityTheftRestoration)
