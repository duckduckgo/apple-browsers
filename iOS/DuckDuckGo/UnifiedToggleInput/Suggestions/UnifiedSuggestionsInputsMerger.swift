...
enum UnifiedSuggestionsInputsMerger {
    ...
    /// so favorites remain visible until the user edits. Shared so any consumer keying off the
    /// not-typing state (e.g. the escape hatch) uses the same rule as the resolver.
