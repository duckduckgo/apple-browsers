...
final class DuckPlayerViewModelTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        mockSettings = MockDuckPlayerSettings(appSettings: AppSettingsMock(), privacyConfigManager: MockPrivacyConfigurationManager(), featureFlagger: MockDuckPlayerFeatureFlagger())
