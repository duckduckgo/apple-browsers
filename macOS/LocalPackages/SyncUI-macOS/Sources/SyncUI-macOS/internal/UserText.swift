...
enum UserText {
    ...
    static let syncWithAnotherDeviceShowQRCodeButton = NSLocalizedString("preferences.sync.sync-with-another-device.show-qr-code-button", bundle: Bundle.module, value: "Scan QR Code", comment: "Text on scan QR code button on Sync with another device dialog")
