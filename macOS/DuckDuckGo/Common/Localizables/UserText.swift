...
struct UserText {
    ...
    static let aiChatChromeHideDuckAIButton = NSLocalizedString("aichat.chrome.hide-duckai-button", value: "Hide Duck.ai Button", comment: "Context menu item to hide the Duck.ai title button in the tab bar")
    static let aiChatChromeShowDuckAIButton = NSLocalizedString("aichat.chrome.show-duckai-button", value: "Show Duck.ai Button", comment: "Context menu item to show the Duck.ai title button in the tab bar")
    ...
    static let aiChatShowDuckAIButtonInTabBarLabel = NSLocalizedString("duckai.show-duckai-button-in-tab-bar.label", value: "Show Duck.ai button in the tab bar", comment: "Label for showing Duck.ai button in tab bar")
