...
enum UserText {
    ...
    enum InactiveUserModal {
        ...
        static let moreProtections = NSLocalizedString("setDefaultBrowser.modal.inactive-user.cta.more-protections.title", bundle: .module, value: "Plus even more protections...", comment: "Title of the button explaining of other browser protections that link to a web page.")
    ...
    enum MoreProtections {
        static let dismissCTA = NSLocalizedString("setDefaultBrowser.modal.more-protections.cta.close", bundle: Bundle.module, value: "Close", comment: "The title of the button to dismiss the webpage explaining of other browser protections.")
    }
}
