...
public struct UserText {
    ...
    public static let cookiePopupProtectionOptInFooter = NSLocalizedString("cookie-popup-protection.opt-in.footer", value: "You can always adjust later in Settings > Cookie Pop-Up Protection.", comment: "Footer text in the Cookie Pop-up Protection opt-in dialog")
    // Variant shown when Cookie Pop-up Protection is already ON
    public static let cookiePopupProtectionOptInEnabledTitle = NSLocalizedString("cookie-popup-protection.opt-in.enabled.title", value: "Want us to handle more cookie pop-ups for you?", comment: "Title of the opt-in dialog when cookie pop-up protection is already enabled")
    public static let cookiePopupProtectionOptInEnabledBody = NSLocalizedString("cookie-popup-protection.opt-in.enabled.body", value: "We can save you a click by accepting cookie pop-ups that don't offer an opt-out.", comment: "Body of the opt-in dialog when cookie pop-up protection is already enabled")
    public static let cookiePopupProtectionOptInEnabledPrimaryOption = NSLocalizedString("cookie-popup-protection.opt-in.enabled.primary-option", value: "Accept those on my behalf", comment: "Primary (recommended) option when cookie pop-up protection is already enabled")
    public static let cookiePopupProtectionOptInEnabledSecondaryOption = NSLocalizedString("cookie-popup-protection.opt-in.enabled.secondary-option", value: "I'll close them myself", comment: "Secondary option when cookie pop-up protection is already enabled")
    // Variant shown when Cookie Pop-up Protection is OFF
    public static let cookiePopupProtectionOptInDisabledTitle = NSLocalizedString("cookie-popup-protection.opt-in.disabled.title", value: "Want us to handle & hide cookie pop-ups for you?", comment: "Title of the opt-in dialog when cookie pop-up protection is off")
    ...
    public static let cookiePopupProtectionOptInDisabledPrimaryOption = NSLocalizedString("cookie-popup-protection.opt-in.disabled.primary-option", value: "Handle cookie pop-ups for me", comment: "Primary (recommended) option when cookie pop-up protection is off")
    public static let cookiePopupProtectionOptInDisabledSecondaryOption = NSLocalizedString("cookie-popup-protection.opt-in.disabled.secondary-option", value: "I'll handle them myself", comment: "Secondary option when cookie pop-up protection is off")
