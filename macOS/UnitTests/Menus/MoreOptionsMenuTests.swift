...
final class MoreOptionsMenuTests: XCTestCase {
    ...
    func testThatMoreOptionMenuHasTheExpectedItemsWhenFreemiumFeatureUnavailable() {
        ...
        XCTAssertEqual(moreOptionsMenu.items[13].title, UserText.deleteBrowsingDataMenuItem)
        XCTAssertTrue(moreOptionsMenu.items[14].isSeparatorItem)
        XCTAssertEqual(moreOptionsMenu.items[15].title, UserText.emailOptionsMenuItem)
        XCTAssertTrue(moreOptionsMenu.items[16].isSeparatorItem)
        XCTAssertEqual(moreOptionsMenu.items[17].title, UserText.subscriptionOptionsMenuItem)
        XCTAssertFalse(moreOptionsMenu.items[17].hasSubmenu)
