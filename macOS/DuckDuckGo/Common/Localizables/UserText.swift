...
// TODO: Done till here
    ...
    static let openFireWindowByDefaultExplanation = NSLocalizedString("preferences.open-fire-window-by-default.explanation", value: "Open Fire Window by default when opening a new window (Command + N). You can still open a regular browser window when this setting is on with Shift + Command + N.", comment: "Explanation for the option to make all new windows Fire Windows")
    ...
    static let disableAutoClearToEnableSessionRestore = NSLocalizedString("disable.auto.clear.to.enable.session.restore",
                                                                          value: "Your session won't be restored if Auto Clear is turned on, or if your last session was in Fire Window.",
