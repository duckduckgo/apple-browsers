...
public struct UserText {
    ...
    public static let aiChatModelPickerProExclusive = NSLocalizedString(
        "aichat.model-picker.pro-exclusive",
        value: "Pro Exclusive",
        comment: "Section header for Pro-only models shown to DuckDuckGo Plus subscribers")
    public static let aiChatModelPickerTryForFree = NSLocalizedString("aichat.model-picker.try-for-free", value: "TRY FOR FREE", comment: "Button in the model picker that opens the DuckDuckGo subscription purchase flow")
    public static let aiChatModelPickerUpgrade = NSLocalizedString("aichat.model-picker.upgrade", value: "UPGRADE", comment: "Button in the model picker that opens the DuckDuckGo subscription upgrade flow")
