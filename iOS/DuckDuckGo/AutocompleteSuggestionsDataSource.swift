...
final class AutocompleteSuggestionsDataSource: SuggestionLoadingDataSource {
    ...
    init(historyManager: HistoryManaging, bookmarksDatabase: CoreDataDatabase, featureFlagger: FeatureFlagger, tabsModel: MutableTabCollection, performSuggestionsRequest: @escaping SuggestionsRequest) {
