...
struct UserText {
    ...
    static let aiFeaturesDisableAllFooter = NSLocalizedString("duckai.ai-features.disable-all.footer", value: "Disables Duck.ai, hides AI-assisted answers in search, and hides AI-generated images.", comment: "Footer text below the Disable AI Features button")
    static let aiFeaturesDisableAllFooterDisabled = NSLocalizedString("duckai.ai-features.disable-all.footer.disabled", value: "AI is currently disabled in the Browser so you’ll no longer see AI-assisted answers or AI-generated images in search results.", comment: "Footer text shown once all AI features are already disabled")
