...
""", comment: "about page")
    ...
    static let scamBlockerToggleLabel = NSLocalizedString("preferences.scam-blocker.toggle-label", value: "Warn on sites flagged for scams, phishing, or malware. [Learn More](ddgQuickLink://duckduckgo.com/duckduckgo-help-pages/privacy/scam-blocker/)", comment: "Label for toggle that enables or disables scam, phishing, and malware site warnings (do not remove or change the link)")
