//
//  RebrandedAddToDockPromoViewModel.swift
//  DuckDuckGo
//
...
final class RebrandedAddToDockPromoViewModel {
    private static let imageName = "img_0.png"

    private let appIconManager: RebrandedAppIconProviding

    var color: LottieColor {
        LottieColor(icon: appIconManager.appIcon)
    }

    init(appIconManager: RebrandedAppIconProviding = AppIconManager.shared) {
        self.appIconManager = appIconManager
    }
}

extension RebrandedAddToDockPromoViewModel: AnimationImageProvider {
