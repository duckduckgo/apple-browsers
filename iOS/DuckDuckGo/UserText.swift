    ...
    public enum Onboarding {
        ...
        public enum Personalization {
            ...
            public enum AdBlocking {
                ...
                public static let adBlockingTitle = NotLocalizedString("onboarding.personalization.adBlocking.youTubeAdBlocking.title", value: "YouTube ad blocking", comment: "Title for the YouTube ad blocking option on the onboarding ad-blocking personalization screen.")
                ...
                public static let rejectOptionalCookiesSubtitle = NotLocalizedString("onboarding.personalization.adBlocking.rejectOptionalCookies.subtitle", value: "Maximizes privacy and hides cookie pop-ups.", comment: "Subtitle for the reject-optional-cookies option on the onboarding ad-blocking personalization screen.")
                public static let acceptOtherCookiesTitle = NotLocalizedString("onboarding.personalization.adBlocking.acceptOtherCookies.title", value: "Accept other cookies", comment: "Title for the accept-other-cookies option on the onboarding ad-blocking personalization screen.")
