...
// TODO: Done till here
    ...
    static let pinnedTabsWarning = NSLocalizedString("preferences-pinned-tabs-warning", value: "Are you sure you want to share pinned tabs across all windows? This can only be undone by switching back to \"Separate in each window\" and manually pinning the tabs in each window again.", comment: "Warning before switching from per window pinned tabs to shared pinned tabs")
