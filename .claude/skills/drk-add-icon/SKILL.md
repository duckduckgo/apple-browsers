...
3. **Create the imageset/symbolset directory:**
   ...
   - Recolorable: `Recolorable/{size}px/{filename-without-.svg}.symbolset/`
...
- **Recolorable lowercase.** Recolorable files (and their containing directory) are lowercase: `check-recolorable-24.svg` / `check-recolorable-24.symbolset/`. Don't title-case them.
