...
struct PermissionCenterView: View {
    ...
    private enum PopoverWidth {
        ...
        static let extraWidth: CGFloat = 380
    ...
    private var popoverWidth: CGFloat {
        ...
        let hasExternalAppsOrAutoplay = viewModel.permissionItems.contains { $0.isGroupedExternalApps || $0.permissionType == .autoplayPolicy }
        ...
        } else if hasExternalAppsOrAutoplay {
            return PopoverWidth.extraWidth
        }
