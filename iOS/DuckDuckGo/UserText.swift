...
public struct UserText {
    ...
    static let netPVPNSettingsCopySupportInfoCopiedToClipboard = NSLocalizedString("network.protection.vpn.settings.copy-support-info.copied-to-clipboard", value: "Copied to clipboard", comment: "Temporary title for the row after VPN support information is copied to the clipboard.")
    static let netPVPNSettingsCopySupportInfoFailedToCopyToClipboard = NSLocalizedString("network.protection.vpn.settings.copy-support-info.failed-to-copy-to-clipboard", value: "Couldn't copy to clipboard", comment: "Temporary title for the row when VPN support information could not be copied to the clipboard.")
