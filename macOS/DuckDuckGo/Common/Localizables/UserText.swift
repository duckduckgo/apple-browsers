...
// TODO: Done till here
    ...
    static let defaultPopoverTitleForSATandATT = NSLocalizedString("sat.att.default.popover.title", value: "Make DuckDuckGo your Defaulf Browser", comment: "Title of the popover when adding DuckDuckGo to the Dock and setting as default browser")
    ...
    static let bothSetAsDefaultPopoverAndAddToDockPromptPrimaryAction = NSLocalizedString("sat.att.both.popover.primary", value: "Set As Default", comment: "Primary action of the popover when adding DuckDuckGo to the Dock and/or setting as default browser")
