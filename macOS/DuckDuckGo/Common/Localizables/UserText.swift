...
// TODO: Done till here
    ...
    static let newTabOmnibarSectionTitle = NSLocalizedString("newTab.favorites.section.omnibar", value: "Search & Duck.ai", comment: "Title of the Search & Duck.ai section in the home page")
