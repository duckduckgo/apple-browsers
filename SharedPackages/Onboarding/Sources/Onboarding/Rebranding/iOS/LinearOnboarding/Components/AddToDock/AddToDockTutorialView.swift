...
extension OnboardingRebranding {
    struct AddToDockTutorialView: View {
        ...
        private static let videoURL = Bundle.module.url(forResource: "add-to-dock-demo", withExtension: "mp4", subdirectory: "Rebranding")!
    ...
    struct AddToDockPreview: View {
        ...
        var body: some View {
            OnboardingRebranding.AddToDockTutorialView(
                ...
                cta: OnboardingRebranding.UserText.AddToDockOnboarding.Buttons.startBrowsing,
