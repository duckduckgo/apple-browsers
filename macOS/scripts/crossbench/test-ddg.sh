...
DISABLE_DELAYED_WEBVIEW_PRESENTATION="${DISABLE_DELAYED_WEBVIEW_PRESENTATION:-0}"
...
bounded_integer DISABLE_DELAYED_WEBVIEW_PRESENTATION 0 1
...
start_app() {
  ...
  if ! DDG_PID="$(
    AUTOMATION_TOKEN="$AUTOMATION_TOKEN_VALUE" \
      ...
      -disableDelayedWebViewPresentation "$DISABLE_DELAYED_WEBVIEW_PRESENTATION" \
