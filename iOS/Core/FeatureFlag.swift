...
public enum FeatureFlag: String {
    ...
    #warning("Add Asana task URL for browserChromeUpdateJuly2026")
    case browserChromeUpdateJuly2026
...
extension FeatureFlag: FeatureFlagDescribing {
    ...
    private var config: Config {
        ...
        case .browserChromeUpdateJuly2026:
            Config(source: .remoteReleasable(iOSBrowserConfigSubfeature.browserChromeUpdateJuly2026))
        case .removeChatHistory:
