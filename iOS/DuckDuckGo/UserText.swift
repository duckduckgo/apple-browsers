...
public struct UserText {
    ...
    public static let settingsPProFreemiumDBPShowResultsCTA = NotLocalizedString("settings.subscription.DBP.freemium.showResults", value: "Show Scan Results", comment: "Freemium PIR CTA shown once the user's first scan has completed")
