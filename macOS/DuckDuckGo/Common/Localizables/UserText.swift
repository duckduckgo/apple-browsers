...
struct UserText {
    ...
    static let youTubeAdBlockingAnalyticsOptInAlertMessage = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.message", value: "Allow DuckDuckGo to anonymously auto-detect video playback issues. This helps to make ad blocking more reliable for everyone.", comment: "Description of the alert shown when the user is enabling YouTube ad blocking")
    static let youTubeAdBlockingAnalyticsOptInAlertConfirmButton = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.confirm", value: "Detect Video Issues", comment: "Confirm button label of the alert shown when the user is enabling YouTube ad blocking")
