...
final class UpdatedOmniBarSearchView: UIView {
    ...
    func hideButtons() {
        leftIconContainerPlaceholder.transform = CGAffineTransform(translationX: -leftIconContainerPlaceholder.frame.maxX * 0.1, y: 0)
        leftIconContainerPlaceholder.alpha = 0

        textField.transform = CGAffineTransform(translationX: -16, y: 0)

        trailingItemsContainer.transform = CGAffineTransform(translationX: (bounds.width - trailingItemsContainer.frame.minX) * 0.1, y: 0)
