//
//  NetworkQualityMonitorRefactored.swift
...
public final class NetworkQualityMonitorRefactored: NetworkQualityMonitoring, NetworkTestProgressReporting {
...
public enum NetworkQualityMonitorFactory {
    ...
    public static func createStandard() -> NetworkQualityMonitoring {
        NetworkQualityMonitorRefactored(configuration: .standard)
    }
    ...
    public static func create(with configuration: TestConfiguration) -> NetworkQualityMonitoring {
        NetworkQualityMonitorRefactored(configuration: configuration)
    }
    
    /// Create a mock monitor for testing
    public static func createMock(httpResponseTester: HttpResponseTesting,
                                  bandwidthTester: BandwidthTesting,
                                  dnsTester: DNSTesting,
                                  bufferBloatTester: BufferBloatTesting,
                                  scoreCalculator: NetworkScoreCalculating) -> NetworkQualityMonitoring {
        NetworkQualityMonitorRefactored(
            configuration: .standard,
            session: URLSession.shared,
            httpResponseTester: httpResponseTester,
            bandwidthTester: bandwidthTester,
            dnsTester: dnsTester,
            bufferBloatTester: bufferBloatTester,
