...
struct UserText {
    ...
    static let removeRecentChatConfirmationMessage = NSLocalizedString("remove.recent.chat.confirmation.message", value: "Are you sure you want to remove \"%@\" from your recent chats?", comment: "Message for the confirmation alert when removing a recent Duck.ai chat. %@ is the chat title.")
