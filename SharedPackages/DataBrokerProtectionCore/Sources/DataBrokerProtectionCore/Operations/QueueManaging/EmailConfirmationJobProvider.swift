...
public final class EmailConfirmationJobProvider: EmailConfirmationJobProviding {
    ...
    public func createEmailConfirmationJobs(showWebView: Bool,
        ...
        Logger.dataBrokerProtection.log("[EmailConfirmationJobProvider] Creating \(confirmations.count, privacy: .public) email confirmation jobs")
        ...
        Logger.dataBrokerProtection.log("[EmailConfirmationJobProvider] Jobs sorted by link obtained date (oldest first)")
