...
public struct UserText {
    ...
    public static let actionNewFireTabForUrl = NSLocalizedString("action.title.newFireTabForUrl", value: "Open in New Fire Tab", comment: "Open in New Fire Tab action")
