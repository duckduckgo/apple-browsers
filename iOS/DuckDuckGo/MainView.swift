...
extension MainViewFactory {
    ...
    private func constrainContentContainer() {
        ...
        coordinator.constraints.contentContainerBottomToDeviceSafeArea =
            contentContainer.bottomAnchor.constraint(equalTo: superview.safeAreaLayoutGuide.bottomAnchor)
    ...
    private func constrainToolbar() {
        ...
        coordinator.constraints.toolbarHeight = toolbar.constrainAttribute(.height, to: BrowserToolbarView.legacyButtonsHeight)
        NSLayoutConstraint.activate([
