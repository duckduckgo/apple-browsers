...
struct DefaultSubscriptionErrorReporter: SubscriptionErrorReporter {
    ...
    func report(subscriptionActivationError: SubscriptionError) {
        ...
        case .purchaseFailed(let error):
            PixelKit.fire(PrivacyProPixel.privacyProPurchaseFailureStoreError, frequency: .legacyDailyAndCount, withError: error)
        case .missingEntitlements:
        ...
        case .accountCreationFailed(let error):
            PixelKit.fire(PrivacyProPixel.privacyProPurchaseFailureAccountNotCreated, frequency: .legacyDailyAndCount, withError: error)
        case .activeSubscriptionAlreadyPresent:
            break
        case .otherPurchaseError:
