...
extension TabViewController {
    ...
    static func fake(
        ...
        let tab = TabViewController.loadFromStoryboard(
            ...
            duckPlayer: MockDuckPlayer(settings: MockDuckPlayerSettings(appSettings: AppSettingsMock(), privacyConfigManager: PrivacyConfigurationManagerMock(), featureFlagger: MockDuckPlayerFeatureFlagger()), featureFlagger: featureFlagger),
