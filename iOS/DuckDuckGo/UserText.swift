...
public struct UserText {
    ...
    static let netPVPNSettingsCopyDiagnosticsCaption = NSLocalizedString("network.protection.vpn.settings.copy-diagnostics.caption", value: "Copies anonymized VPN diagnostic information to your clipboard. Include it when contacting Support to help us troubleshoot your connection.", comment: "Caption beneath the Copy VPN Diagnostics row, explaining what it does.")
    ...
    static let netPVPNSettingsCopyDiagnosticsCopied = NSLocalizedString("network.protection.vpn.settings.copy-diagnostics.copied", value: "VPN diagnostics copied", comment: "Toast shown after VPN diagnostic information is copied to the clipboard.")
    static let netPVPNSettingsCopyDiagnosticsFailed = NSLocalizedString("network.protection.vpn.settings.copy-diagnostics.failed", value: "Couldn't copy VPN diagnostics", comment: "Toast shown when VPN diagnostic information could not be copied to the clipboard.")
