...
struct UserText {
    ...
    static let problemSubcategoryPopupWindowsNotOpening = NSLocalizedString("feedback.problem-subcategory.popup-windows-not-opening", value: "Pop-up windows not opening or broken", comment: "Problem subcategory for popup windows being blocked")
