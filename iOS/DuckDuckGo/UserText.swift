...
public struct UserText {
    ...
    public static let settingsForceWebsiteDarkMode = NSLocalizedString("settings.force.website.dark.mode", value: "Force Sites To Use Dark Mode", comment: "Settings screen toggle for forcing dark mode on websites")
    public static let settingsThemeSectionFooter = NSLocalizedString("settings.theme.section.footer", value: "Gives sites a dark appearance if you’re using dark theme", comment: "Footer shown right below the first section, which has the force dark mode item at the last position")
