...
final class BrokerProfileJobActionTests: XCTestCase {
    ...
    let stageCalulator = DataBrokerProtectionStageDurationCalculator(dataBrokerURL: "broker", dataBrokerVersion: "1.1.1", handler: MockDataBrokerProtectionPixelsHandler(), vpnConnectionState: "disconnected", vpnBypassStatus: "off")
