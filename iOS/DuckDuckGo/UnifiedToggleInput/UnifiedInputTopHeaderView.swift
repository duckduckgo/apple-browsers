...
/// Shown at the top of the screen when the UTI is in bottom-bar inactive state
/// (keyboard dismissed, content still visible). Contains a section title and a dismiss button.
