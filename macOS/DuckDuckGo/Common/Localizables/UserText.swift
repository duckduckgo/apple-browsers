...
struct UserText {
    ...
    static let aiChatAttachMenuImageOrFile = NSLocalizedString("aichat.attach-menu.image-or-file", value: "Attach Image or File", comment: "Top-level item in the AI chat omnibar attach menu that opens the image and file picker")
    static let aiChatAttachMenuPageContent = NSLocalizedString("aichat.attach-menu.page-content", value: "Attach Page Content", comment: "Top-level item in the AI chat omnibar attach menu that opens the open-tabs submenu")
    static let aiChatAttachMenuRecentTabsHeader = NSLocalizedString("aichat.attach-menu.recent-tabs-header", value: "Recent Tabs", comment: "Section header inside the AI chat omnibar attach menu listing the user's currently open browser tabs")
    static let aiChatAttachMenuNoOpenTabs = NSLocalizedString("aichat.attach-menu.no-open-tabs", value: "No open tabs", comment: "Placeholder shown inside the AI chat omnibar attach menu when the user has no open browser tabs to choose from")
