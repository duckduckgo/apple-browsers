...
This package depends on [DesignResourceKit](https://github.com/duckduckgo/apple-browsers/SharedPackages/DesignResourcesKit), which provides the foundational Design System atoms. It is crucial to understand that:
