...
extension FeatureFlag: FeatureFlagDescribing {
    ...
    private var config: Config {
        ...
        case .aiChatContextualFloatingInput:
            Config(defaultValue: .disabled, source: .remoteReleasable(AIChatSubfeature.contextualFloatingInput))
        case .unifiedToggleInputAttachmentPaste:
        ...
        case .onboardingFlowByDownloadReasonExperiment:
            Config(defaultValue: .internalOnlyWithCohort(OnboardingFlowByDownloadReasonExperimentCohort.control), source: .disabled, supportsLocalOverriding: true, cohortType: OnboardingFlowByDownloadReasonExperimentCohort.self)
        case .monthlyFreeTrialExperiment2:
