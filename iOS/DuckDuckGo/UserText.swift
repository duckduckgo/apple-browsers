...
public struct UserText {
    ...
    public static let settingsItemPreviewBadge = NSLocalizedString("settings.item.badge.preview", value: "Preview", comment: "Copy for budge on settings item to show an item is experimental")
