...
public struct UserText {
    ...
    static let simplifiedSyncHeaderMessageV2 = NotLocalizedString("sync.simplified.header.message.v2", bundle: Bundle.module, value: "Sync your autofill data, bookmarks, and Duck.ai chats, end-to-end encrypted across your DuckDuckGo apps.", comment: "Description of the Sync & Backup feature (when AI chat sync is available)")
