...
enum UserText {
    ...
    static let syncWithAnotherDeviceCopyConfirmationTitle = NSLocalizedString("preferences.sync.sync-with-another-device.copy-confirmation.title", bundle: Bundle.module, value: "Don’t close this window", comment: "Title of the reminder shown after the user copies the sync code, telling them to keep the window open.")
    static let syncWithAnotherDeviceCopyConfirmationMessage = NSLocalizedString("preferences.sync.sync-with-another-device.copy-confirmation.message", bundle: Bundle.module, value: "Open DuckDuckGo on your other device and paste the code.", comment: "Message of the reminder shown after the user copies the sync code.")
