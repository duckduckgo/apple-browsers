...
public protocol DataBrokerOperationDependencies {
    ...
    var vpnBypassFeatureProvider: VPNBypassFeatureProviding { get }
}
...
public struct DefaultDataBrokerOperationDependencies: DataBrokerOperationDependencies {
    ...
    public let vpnBypassFeatureProvider: VPNBypassFeatureProviding
    ...
    private func runOperation() async {
        ...
        for operationData in filteredAndSortedOperationsData {
            ...
            do {
                ...
                try await DataBrokerProfileQueryOperationManager(vpnIPCClient: VPNControllerXPCClient.shared, vpnBypassFeatureProvider: operationDependencies.vpnBypassFeatureProvider).runOperation(operationData: operationData,
