...
final class OnboardingNavigatingTests: XCTestCase {
    ...
    func testOnImportData_DataImportViewShown() throws {
        ...
        let mvc = MainWindowController(window: mockWindow, mainViewController: MainViewController(autofillPopoverPresenter: DefaultAutofillPopoverPresenter(), fireViewModel: FireViewModel()), popUp: false, fireViewModel: FireViewModel())
