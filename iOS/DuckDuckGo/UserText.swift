...
public struct UserText {
    ...
    static func autofillOnboardingKeyFeaturesSecureStorageDescription(biometryString: String) -> String {
        let localized = NSLocalizedString("autofill.onboarding.key-features.secure-storage.description.biometric", value: "Passwords are encrypted, stored on device, and locked with %@.", comment: "Description of autofill onboarding prompt's secure storage feature with a string describing the available biometry + passcode as a parameter")
    ...
    public static let vpnContentBlockingFilteringTitle = NSLocalizedString("vpn.settings.dns.server.content.blocking.filtering.title", value: "Block risky domains", comment: "Title of the vpn blocks risky sites feature settings")
    public static let vpnContentBlockingFilteringHeader = NSLocalizedString("vpn.settings.dns.server.content.blocking.filtering.header", value: "Content Blocking and Filtering", comment: "Header of the vpn blocks risky sites feature settings")
    public static let vpnContentBlockingFilteringFooter = NSLocalizedString("vpn.settings.dns.server.content.blocking.filtering.explanation", value: "Block 150,000+ domains flagged for hosting malware, phishing attacks, and online scams with a DNS-level blocklist. [Learn More](ddgQuickLink://duckduckgo.com/duckduckgo-help-pages/privacy-pro/vpn/dns-blocklists/)", comment: "Explanation in Settings how the vpn blocks risky sites (do not remove the link)")
