...
public struct UserText {
    ...
    public static let duckAiAddressBarMenuRecentChats = NSLocalizedString("duckai.address.bar.menu.recent.chats", value: "Recent Chats", comment: "Address bar Duck.ai menu option that opens the list of recent chats")
