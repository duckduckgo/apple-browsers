...
enum DocumentPageContextProvider {
    ...
    static let maxDocumentBytes = 30 * 1024 * 1024
    ...
    static func isSupportedDocument(mimeType: String?, url: URL) -> Bool {
    ...
    @MainActor
    static func makeDocumentContext(webView: MainResourceDataProviding,
                                    url: URL,
                                    title: String,
    ...
    static func metadataContext(url: URL,
                                title: String,
                                favicon: [AIChatPageContextData.PageContextFavicon] = [],
                                attachable: Bool? = nil,
