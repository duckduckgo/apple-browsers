...
struct DefaultBrowserPromptDeciderInactiveUserTests {
    ...
    func whenHasInactiveModalShownStoreValueIsTrueThenReturnFalse() {
        ...
        let sut = DefaultBrowserPromptTypeDecider.InactiveUser(store: storeMock, userActivityProvider: userActivityProviderMock, daysSinceInstallProvider: { numberOfDaysSinceInstall })
