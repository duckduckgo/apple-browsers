...
final class DataBrokerJobTests: XCTestCase {
    ...
    func testWhenClickDelayOptimizationFlagIsOn_thenOptOutRunnerUsesOptimizedDelay() {
        // Given
        ...
        // Then
        XCTAssertEqual(runner.clickAwaitTime, 3)
    }

    func testWhenClickDelayOptimizationFlagIsOff_thenOptOutRunnerUsesLegacyDelay() {
        // Given
        ...
        // Then
        XCTAssertEqual(runner.clickAwaitTime, 40)
    }

    func testScanRunner_alwaysUsesZeroClickDelay() {
        // Given/When
        let runner = BrokerProfileScanSubJobWebRunner(
            ...
            emailConfirmationDataService: MockEmailConfirmationDataServiceProvider(),
            captchaService: CaptchaServiceMock(),
            featureFlagger: MockDBPFeatureFlagger(isClickActionDelayReductionOptimizationOn: true),
            clickAwaitTime: 0,
        ...
        // Then
        XCTAssertEqual(runner.clickAwaitTime, 0)
    }
}
