...
final class PrivacyIconAndTrackersAnimator {
    ...
    func startAnimating(in omniBar: OmniBarView, with privacyInfo: PrivacyInfo) {
    ...
    func startAnimationForDaxDialog(in omniBar: OmniBarView, with privacyInfo: PrivacyInfo) {
        guard let container = omniBar.privacyInfoContainer else { return }
    ...
    func completeAnimationForDaxDialog(in omniBar: OmniBarView) {
        guard let container = omniBar.privacyInfoContainer else { return }
    ...
    func cancelAnimations(in omniBar: OmniBarView) {
        guard let container = omniBar.privacyInfoContainer else { return }
