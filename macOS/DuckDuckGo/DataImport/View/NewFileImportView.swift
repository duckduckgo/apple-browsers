...
@NewInstructionsView.InstructionsBuilder
func newFileImportSingleTypeInstructionsBuilder(source: DataImport.Source, dataType: DataImport.DataType, button: @escaping (String) -> AnyView) -> [NewInstructionsView.InstructionsItem] {
