...
/// from a backend call (`AIChatModelsService`) prefetched by ``SubscriptionOnboardingPrefetcher`` and exposed
/// via the view model, so this holds no state and makes no network calls itself.
///
