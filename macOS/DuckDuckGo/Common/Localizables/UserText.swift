...
struct UserText {
    ...
    static let permissionCenterAutoplayDisclaimerWebsitePermissionsLink = NSLocalizedString("permission.center.autoplay.disclaimer.website-permissions.link", value: "Settings → Website Permissions → Autoplay.", comment: "Clickable label in the autoplay disclaimer UI that opens the Website Permissions settings pane")
    ...
    static let autoplayMovedCaption = NSLocalizedString("preferences.autoplay.moved.caption", value: "Autoplay settings moved to Website Permissions.", comment: "Caption in General preferences telling the user where the autoplay setting now lives")
    static let autoplayMovedLink = NSLocalizedString("preferences.autoplay.moved.link", value: "Show Website Permissions", comment: "Button in General preferences that opens the Website Permissions settings pane")
