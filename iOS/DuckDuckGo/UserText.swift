...
public struct UserText {
    ...
    public static let settingsDefaultOmnibarModeFooter = NSLocalizedString("settings.default.omnibar.mode.footer", value: "Default toggle position on new tabssdfs fs fs fds f.", comment: "Footer text explaining the toggle position setting in AI Features settings")
