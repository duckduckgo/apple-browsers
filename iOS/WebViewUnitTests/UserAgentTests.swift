...
final class UserAgentTests: XCTestCase {
    ...
    private struct ExpectedAgent {
        ...
        static func backwardsCompatibileVersion(_ fallback: String) -> String {
            osVersion.majorVersion < 26 ? fallback : "\(osVersion.majorVersion).\(osVersion.minorVersion)"
        }

        // Based on DefaultAgent values
        static let mobile = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 DuckDuckGo/7 Safari/605.1.15"
        static let tablet = "Mozilla/5.0 (iPad; CPU OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 DuckDuckGo/7 Safari/605.1.15"
        static let desktop = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) DuckDuckGo/7 Safari/605.1.15"
        static let oldWebkitVersionMobile = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.14 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 DuckDuckGo/7 Safari/605.1.14"
        static let newWebkitVersionMobile = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 DuckDuckGo/7 Safari/604.1"
        static let sameWebkitVersionMobile = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 DuckDuckGo/7 Safari/604.1"

        static let mobileNoApplication = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("12.4")) Mobile/15E148 Safari/605.1.15"

        // Based on fallback constants in UserAgent
        static let mobileFallback = "Mozilla/5.0 (iPhone; CPU iPhone OS 13_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("13.5")) Mobile/15E148 DuckDuckGo/7 Safari/605.1.15"
        static let desktopFallback = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/\(backwardsCompatibileVersion("13.5")) DuckDuckGo/7 Safari/605.1.15"
