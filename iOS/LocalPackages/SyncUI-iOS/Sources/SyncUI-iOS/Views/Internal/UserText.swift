...
public struct UserText {
    ...
    static let simplifiedSyncToggleTitleThisDevice = NotLocalizedString("sync.simplified.toggle.title.this.device", bundle: Bundle.module, value: "Sync This Device", comment: "Sync & Backup enabled / disabled toggle title, referring to the current device")
    ...
    static let simplifiedSyncHeaderMessageV2 = NotLocalizedString("sync.simplified.header.message.v2", bundle: Bundle.module, value: "Sync and back up your autofill data, bookmarks, and Duck.ai chats, end-to-end encrypted across your DuckDuckGo apps.", comment: "Description of the Sync & Backup feature (when AI chat sync is available)")
    static let simplifiedSyncHeaderMessageBasicV2 = NotLocalizedString("sync.simplified.header.message.basic.v2", bundle: Bundle.module, value: "Sync your autofill data and bookmarks, end-to-end encrypted across your DuckDuckGo apps.", comment: "Description of the Sync & Backup feature")
    ...
    static let simplifiedRecoverSyncedDataSectionHeader = NotLocalizedString("sync.simplified.recover.synced.data.section.header", bundle: Bundle.module, value: "Recover Synced Data", comment: "Section header above the recovery-code option in sync setup")
    static let simplifiedHaveRecoveryCodeButton = NotLocalizedString("sync.simplified.have.recovery.code.button", bundle: Bundle.module, value: "I Have a Recovery Code", comment: "Sync setup row label to recover synced data using an existing recovery code")
    static let simplifiedDownloadSectionHeader = NotLocalizedString("sync.simplified.download.section.header", bundle: Bundle.module, value: "Download", comment: "Section header above the get-desktop-browser option in sync setup")
    static let simplifiedGetOurDesktopBrowserTitle = NotLocalizedString("sync.simplified.get.our.desktop.browser.title", bundle: Bundle.module, value: "Get Our Desktop Browser", comment: "Row label to get the DuckDuckGo desktop browser")
    ...
    static let simplifiedSyncThisDeviceOnly = NotLocalizedString("sync.simplified.this.device.only", bundle: Bundle.module, value: "Sync This Device Only", comment: "Button on the sync-setup prompt to enable Sync & Backup on the current device only, without pairing another device")
    static let simplifiedSyncAnotherDeviceV2Title = NotLocalizedString("sync.simplified.another.device.v2.title", bundle: Bundle.module, value: "Sync this device with a nearby computer.", comment: "Title on the sync-setup prompt asking whether to sync with another device or just this device")
    static let simplifiedSyncAnotherDeviceV2Body = NotLocalizedString("sync.simplified.another.device.v2.body", bundle: Bundle.module, value: "We’ll help you sync your devices.", comment: "Body on the sync-setup prompt explaining the sync-another-device option")
