...
struct RebrandedOnboardingView: View {
    ...
    @ObservedObject private var model: RebrandedOnboardingIntroViewModel

    @State private var isPlayingSetAsDefaultVideo: Bool = false

    init(model: RebrandedOnboardingIntroViewModel) {
        self.model = model
    }
...
extension RebrandedOnboardingView {
...
extension RebrandedOnboardingView.ViewState {
...
extension RebrandedOnboardingView.ViewState.Intro {
...
private extension View {
    ...
    func onboardingProgressIndicator(currentStep: Int, totalSteps: Int) -> some View {
        overlay(alignment: .topTrailing) {
            RebrandedOnboardingProgressIndicator(stepInfo: .init(currentStep: currentStep, totalSteps: totalSteps))
