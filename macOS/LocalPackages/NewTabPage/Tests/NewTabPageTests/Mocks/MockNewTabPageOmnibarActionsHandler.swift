...
final class MockNewTabPageOmnibarActionsHandler: NewTabPageOmnibarActionsHandling {
    ...
    var submitChatHandler: ((String, NewTabPageDataModel.OpenTarget, Bool, String?, [NewTabPageDataModel.SubmitChatImage]?) -> Void)?
    ...
    @MainActor
    func submitChat(_ chat: String, target: NewTabPageDataModel.OpenTarget, webSearch: Bool, modelId: String?, images: [NewTabPageDataModel.SubmitChatImage]?) {
        submitChatHandler?(chat, target, webSearch, modelId, images)
    }
