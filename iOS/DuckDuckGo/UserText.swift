...
public struct UserText {
    ...
    public static let utiCreateImageModelSwitchPrivacyPreservingSubtitle = NSLocalizedString("aichat.createImage.modelSwitch.privacyPreserving.subtitle", value: "%@ can't create images. Its extra privacy protections won't apply until you switch back.", comment: "Subtitle of the Duck.ai input footer card shown when the model that was switched away from is one of the models with extra privacy protections. %@ is that model's short name, such as 'Gemma'")
