...
public extension DataManager {
    enum StoredDataType: Hashable, CaseIterable {
        ...
        static func dataTypes(for kind: DataManager.StoredDataType.Kind, supportedThreatKind: [ThreatKind]) -> [DataManager.StoredDataType] {
            supportedThreatKind.map { threatKind in
                switch kind {
                case .hashPrefixSet: .hashPrefixSet(.init(threatKind: threatKind))
                case .filterSet: .filterSet(.init(threatKind: threatKind))
                }
