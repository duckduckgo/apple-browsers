    ...
    getBaseRules = true, getInjectionRules = true, getExtendedRules = true, getRulesFromDOM = true, getRulesFromHostname = true, hidingStyle, callerContext, }) {
        ...
        if (filters.length !== 0) {
            ...
            for (const filter of filters) {
                ...
                const exception = unhideExceptions.get((0, cosmetic_js_1.normalizeSelector)(filter, this.resources.getScriptletCanonicalName.bind(this.resources)));
                if (exception !== undefined) {
                    continue;
                }
                let applied = false;
