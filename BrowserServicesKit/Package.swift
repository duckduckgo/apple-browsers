...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/duckduckgo/privacy-dashboard", exact: "8.6.0"),
        ...
        .package(url: "https://github.com/duckduckgo/DesignResourcesKit.git", branch: "mariusz/add-alternative-colors")
    ],
    targets: [
        .target(
            name: "BrowserServicesKit",
