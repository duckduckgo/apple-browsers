...
struct OnboardingSubscriptionPromotionHelper: OnboardingSubscriptionPromotionHelping {
    ...
    init(featureFlagger: FeatureFlagger = AppDependencyProvider.shared.featureFlagger, subscriptionManager: any SubscriptionManagerV2 = AppDependencyProvider.shared.subscriptionManagerV2, pixelFiring: PixelFiring.Type = Pixel.self) {
