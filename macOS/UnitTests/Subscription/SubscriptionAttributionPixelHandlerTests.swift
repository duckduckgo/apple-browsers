...
final class SubscriptionAttributionPixelHandlerTests: XCTestCase {
    private var sut: DuckDuckGoSubscriptionAttributionPixelHandler!
    ...
    func testWhenPixelFiresThenNameIsSetToM_Mac_DistributionType_Subscribe() {
        ...
        sut = DuckDuckGoSubscriptionAttributionPixelHandler(attributionPixelHandler: decoratedPixelHandler)
