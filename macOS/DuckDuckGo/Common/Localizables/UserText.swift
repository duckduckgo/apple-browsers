...
struct UserText {
    ...
    static let promptBarKeyboardShortcutToggle = NotLocalizedString("duckai.prompt-bar.keyboard-shortcut.toggle", value: "Show Duck.ai with keyboard shortcut", comment: "Checkbox in Settings → AI Features that enables the system-wide Duck.ai keyboard shortcut")
    ...
    static let promptBarMenuBarIconCaption = NotLocalizedString("duckai.prompt-bar.menu-bar-icon.caption", value: "Adds Duck.ai icon to your Mac menu bar beside Wi-Fi and Clock", comment: "Caption under the 'Show Duck.ai in menu bar' checkbox describing where the icon appears")
