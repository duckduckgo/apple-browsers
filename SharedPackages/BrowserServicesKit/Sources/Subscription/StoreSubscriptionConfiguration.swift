    ...
    convenience init() {
        self.init(subscriptionDefinitions: [
            ...
            .init(name: "DuckDuckGo Private Browser",
                  ...
                  identifiersByRegion: [.usa: ["ddg.privacy.pro.monthly.renews.us.\(StoreSubscriptionConstants.freeTrialIdentifer)",
                                        ...
                                        .restOfWorld: ["ddg.privacy.pro.monthly.renews.row.\(StoreSubscriptionConstants.freeTrialIdentifer)",
            ...
            .init(name: "DuckDuckGo Alpha",
                  ...
                  environment: .staging,
                  identifiersByRegion: [.usa: ["ios.subscription.1month.\(StoreSubscriptionConstants.freeTrialIdentifer).dev",
                                        ...
                                        .restOfWorld: ["ios.subscription.1month.row.\(StoreSubscriptionConstants.freeTrialIdentifer).dev",
            ...
            .init(name: "IAP debug - DDG for macOS",
                  ...
                  environment: .staging,
                  identifiersByRegion: [.usa: ["subscription.1month.\(StoreSubscriptionConstants.freeTrialIdentifer)",
                                        ...
                                        .restOfWorld: ["subscription.1month.row.\(StoreSubscriptionConstants.freeTrialIdentifer)",
            ...
            .init(name: "IAP review - DDG for macOS",
                  ...
                  environment: .staging,
                  identifiersByRegion: [.usa: ["review.subscription.1month.\(StoreSubscriptionConstants.freeTrialIdentifer)",
                                        ...
                                        .restOfWorld: ["review.subscription.1month.row.\(StoreSubscriptionConstants.freeTrialIdentifer)",
            ...
            .init(name: "DuckDuckGo Sandbox Review",
                  ...
                  environment: .staging,
                  identifiersByRegion: [.usa: ["tf.sandbox.subscription.1month.\(StoreSubscriptionConstants.freeTrialIdentifer)",
                                        ...
                                        .restOfWorld: ["tf.sandbox.subscription.1month.row.\(StoreSubscriptionConstants.freeTrialIdentifer)",
