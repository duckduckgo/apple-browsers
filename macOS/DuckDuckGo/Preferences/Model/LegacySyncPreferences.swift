...
extension LegacySyncPreferences: SyncConnectionControllerDelegate {
    ...
    private func sendSetupEndedFailedPixel(setupRole: SyncSetupRole, reason: String?, timeoutStage: String? = nil, pairingV2FailureContext: PairingV2FailureContext? = nil) {
        switch setupRole {
