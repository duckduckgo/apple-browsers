...
public final class MockSubscriptionUserScriptHandler: SubscriptionUserScriptHandling {
    ...
    public var getFeatureConfig: (Any, any UserScriptMessage) async throws -> SubscriptionUserScript.DataModel.GetFeatureConfigurationResponse = { _, _ in .init(useProTier: false) }
