...
struct UserText {
    ...
    static let websitePermissionsRecentsSection = NotLocalizedString("preferences.website-permissions.recents",
                                                                     value: "Recents",
                                                                     comment: "Section header above the most recently changed website permissions")
    static let websitePermissionsExternalAppFormat = NotLocalizedString("preferences.website-permissions.external-app.format",
                                                                       value: "Open “%@”",
                                                                       comment: "Label for an external app permission row, %@ is the app name such as Mail")
    static let websitePermissionsRemovePermission = NotLocalizedString("preferences.website-permissions.remove",
                                                                      value: "Remove",
                                                                      comment: "Accessibility label for the button that removes a saved website permission")
