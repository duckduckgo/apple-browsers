...
final class MockNewTabPageOmnibarActionsHandler: NewTabPageOmnibarActionsHandling {
    ...
    var submitChatHandler: ((String, NewTabPageDataModel.OpenTarget, String?, [NewTabPageDataModel.SubmitChatImage]?, String?) -> Void)?
    ...
    @MainActor
    func submitChat(_ chat: String, target: NewTabPageDataModel.OpenTarget, modelId: String?, images: [NewTabPageDataModel.SubmitChatImage]?, reasoningEffort: String?) {
        submitChatHandler?(chat, target, modelId, images, reasoningEffort)
    }
