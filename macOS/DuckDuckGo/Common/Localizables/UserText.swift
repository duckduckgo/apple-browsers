...
struct UserText {
    ...
    // Subscription Promo on Fire Window
    static let subscriptionPromoTitle = NSLocalizedString("subscription.promo.title", value: "Go beyond the Fire Window with our VPN", comment: "Title for subscription promo card shown on the Fire Window home page")
    static let subscriptionPromoSubtitle = NSLocalizedString("subscription.promo.subtitle", value: "Protect more of what you do online.", comment: "Subtitle for subscription promo card shown on the Fire Window home page")
    static let subscriptionPromoTryForFree = NSLocalizedString("subscription.promo.try.for.free", value: "Try For Free", comment: "Button title for free trial offer on subscription promo card")
    static let subscriptionPromoLearnMore = NSLocalizedString("subscription.promo.learn.more", value: "Learn More", comment: "Button title to learn more about subscription on promo card")
