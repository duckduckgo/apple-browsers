...
description: "User Default Settings storage and reading patterns using @UserDefaultsWrapper and custom property wrappers for DuckDuckGo browser"
keywords: ["property wrappers", "UserDefaults", "@UserDefaultsWrapper", "@Published", "settings", "storage", "encryption"]
alwaysApply: false
---
...
See `feature-flags.md` for feature flag property wrappers and `configuration-management.md` for advanced configuration patterns.