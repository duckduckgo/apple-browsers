...
// TODO: Done till here
    ...
    static let pinnedTabsDescription = NSLocalizedString("preferences-pinned-tabs.description", value: "Choose how pinned tabs behave across browser windows.", comment: "Pinned tabs Settings section description")
    ...
    static let perWindowPinnedTabs = NSLocalizedString("preferences-pinned-tabs-per-window", value: "Specific to each window", comment: "Option for pinned tabs behavior")
    ...
    static let pinnedTabsDiscoveryPopoverTitle = NSLocalizedString("pinned-tabs.discovery.popover.title", value: "Switch between pinned tab approaches", comment: "Title for pinned tabs discoverability dialog")
    static let pinnedTabsDiscoveryPopoverMessage = NSLocalizedString("pinned-tabs.discovery.popover.message", value: "You can adjust the behavior of pinned tabs to per window pinned tabs or shared across all windows.", comment: "Info message to users about option to adjust behavior of pinned tabs")
    ...
    static let pinnedTabsDiscoveryPopoverAccept = NSLocalizedString("pinned-tabs.discovery.popover.accept", value: "Go to Settings…", comment: "Button opening Settings")
