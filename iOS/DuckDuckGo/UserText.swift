...
public struct UserText {
    ...
    static let netPStrictRoutingSettingFooter = NSLocalizedString("network.protection.vpn.strict.routing.setting.footer", value: "We recommend keeping this on when using networks you don't trust. If you're having trouble reaching local devices or other networks, try turning it off.", comment: "Footer text for the Strict Routing setting item.")
