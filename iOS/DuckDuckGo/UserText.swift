...
public struct UserText {
    ...
    public static let actionHideAIChatDuckAIButton = NotLocalizedString("action.title.aiChat.hideDuckAIButton", value: "Hide Duck.ai Shortcut", comment: "Long-press menu item on the iPad Duck.ai chrome chip that hides the Duck.ai (open) button half. Not translated; final copy will land in a follow-up PR.")

    public static let actionShowAIChatDuckAIButton = NotLocalizedString("action.title.aiChat.showDuckAIButton", value: "Show Duck.ai Shortcut", comment: "Long-press menu item on the iPad Duck.ai chrome chip that re-shows the Duck.ai (open) button half. Not translated; final copy will land in a follow-up PR.")

    public static let actionHideAIChatContextualSheetButton = NotLocalizedString("action.title.aiChat.hideContextualSheetButton", value: "Hide Bottom Sheet Shortcut", comment: "Long-press menu item on the iPad Duck.ai chrome chip that hides the bottom-sheet button half. Not translated; final copy will land in a follow-up PR.")

    public static let actionShowAIChatContextualSheetButton = NotLocalizedString("action.title.aiChat.showContextualSheetButton", value: "Show Bottom Sheet Shortcut", comment: "Long-press menu item on the iPad Duck.ai chrome chip that re-shows the bottom-sheet button half. Not translated; final copy will land in a follow-up PR.")
