...
public extension URL {
    ...
    // Temporary product testing override; not intended for main.
    static let privacyConfig = URL(string: "https://duckduckgo.github.io/privacy-configuration/pr-5540/v4/ios-config.json")!
