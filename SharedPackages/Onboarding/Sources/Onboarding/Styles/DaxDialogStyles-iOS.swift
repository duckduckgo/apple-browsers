...
public extension View {
    ...
    public func onboardingDaxDialogStyle() -> some View {
        modifier(OnboardingStyles.DaxDialogStyle())
    }

    public func onboardingContextualBackgroundStyle(background: OnboardingBackgroundType) -> some View {
        modifier(OnboardingStyles.BackgroundStyle(backgroundType: background))
    }

}

public enum OnboardingBackgroundType {
    case illustratedGradient
    case gradientOnly
}
#endif
