...
public struct UserText {
    ...
    public static let actionSummarizeWithAIChat = NSLocalizedString("action.title.aiChat.summarizeWithDuckAI", value: "Summarize", comment: "Edit-menu action shown on text selected in the browser; asks Duck.ai to summarize the selection straight away. Sits in a group of Duck.ai items, so the label stays short")
    public static let actionTranslateWithAIChat = NSLocalizedString("action.title.aiChat.translateWithDuckAI", value: "Translate", comment: "Edit-menu action shown on text selected in the browser; asks Duck.ai to translate the selection straight away. Sits in a group of Duck.ai items, so the label stays short")
