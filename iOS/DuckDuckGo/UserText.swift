...
public struct UserText {
    ...
    public static let settingsAfterInactivityIdleIntervalPlaceholder = NSLocalizedString("settings.afterInactivity.idle.interval.placeholder", value: "5 minutes", comment: "Placeholder idle interval in settings footer until remote config value is used")
