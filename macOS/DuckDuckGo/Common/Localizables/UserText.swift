...
struct UserText {
    ...
    static let aiChatWebSearchToolSubtitle = NSLocalizedString("aichat.web-search-tool.subtitle", value: "Find current information", comment: "Subtitle for Web Search tool in the tools dropdown menu")
