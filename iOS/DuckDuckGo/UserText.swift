...
public struct UserText {
    ...
    public static let tabSwitcherTrackerCountSubtitle = NSLocalizedString("tab.switcher.tracker.count.subtitle", value: "in the last\u{00A0}7\u{00A0}days", comment: "Subtitle for tracker count banner indicating time window")
