...
struct UserText {
    ...
    static let aiChatAttachSelection = NSLocalizedString("duckai.attach-selection.context-menu-action", value: "Attach to Duck.ai", comment: "Context menu option that attaches the selected text to Duck.ai as page context")
