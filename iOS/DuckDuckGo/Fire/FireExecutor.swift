...
class FireExecutor: FireExecuting {
    ...
    init(tabManager: TabManaging,
         ...
         sitePermissionsStore: SitePermissionsStore? = nil,
        ...
        self.fireWorkers = [
            ...
            TextZoomFireWorker(fireproofing: fireproofing,
                               ...
                               dataClearingWideEventService: dataClearingWideEventService),
            PermissionsFireWorker(store: sitePermissionsStore ?? SitePermissionsStore(storage: UserDefaults.app.keyedStoring()),
                                  fireproofing: fireproofing,
                                  dataClearingWideEventService: dataClearingWideEventService),
