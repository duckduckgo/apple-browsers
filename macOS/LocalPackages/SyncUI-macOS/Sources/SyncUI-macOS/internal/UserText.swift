...
enum UserText {
    ...
    // Device selection prompt shown after enabling Sync (V2 — simplifiedSyncSetupV2). Not localized while behind the feature flag.
    static let syncAnotherDevicePromptTitleV2 = NotLocalizedString("preferences.sync.another-device-prompt-v2.title", value: "Sync this device with a nearby phone.", comment: "Title of the prompt asking whether to sync with another device or just this device (V2)")
    static let syncAnotherDevicePromptSubtitleV2 = NotLocalizedString("preferences.sync.another-device-prompt-v2.subtitle", value: "We’ll help you sync your devices.", comment: "Subtitle of the prompt asking whether to sync with another device or just this device (V2)")
    ...
    static let syncAuthenticationCancelledCloseButtonV2 = NotLocalizedString("preferences.sync.authentication-cancelled-v2.close-button", value: "Close", comment: "Button to dismiss the alert shown when the user cancels the device authentication prompt while setting up Sync (V2)")

    // Sync Enabled View (V2 — simplifiedSyncSetupV2). Not localized while behind the feature flag.
    static let syncEnabledFooterV2 = NotLocalizedString("preferences.sync-enabled-v2.footer", value: "Your bookmarks, autofill data, and Duck.ai chats, are being synced with end-to-end encryption. Support for certain data types depends on the platform. [Learn More](https://duckduckgo.com/duckduckgo-help-pages/sync-and-backup/sync-and-backup-privacy/)", comment: "Footer describing what is being synced in sync settings when sync is enabled (V2). The [text](url) markdown is a link and must be preserved.")
    static let syncEnabledFooterWithoutAIChatV2 = NotLocalizedString("preferences.sync-enabled-v2.footer-without-ai-chat", value: "Your bookmarks and autofill data are being synced with end-to-end encryption. Support for certain data types depends on the platform. [Learn More](https://duckduckgo.com/duckduckgo-help-pages/sync-and-backup/sync-and-backup-privacy/)", comment: "Footer describing what is being synced in sync settings when sync is enabled and Duck.ai chat sync is unavailable (V2). The [text](url) markdown is a link and must be preserved.")
    static let myDevicesV2 = NotLocalizedString("preferences.sync.my-devices-v2", value: "My Devices", comment: "Synced devices section title in sync settings (V2)")
    static let myDevicesFooterV2 = NotLocalizedString("preferences.sync.my-devices-footer-v2", value: "Your data is end-to-end encrypted. Nobody but you can see your data, not even us.", comment: "Footer under the synced devices section in sync settings (V2)")
    static let bookmarksSectionTitleV2 = NotLocalizedString("preferences.sync.bookmarks-section-title-v2", value: "Bookmarks", comment: "Bookmarks options section title in sync settings (V2)")
    static let shareFavoritesOptionTitleV2 = NotLocalizedString("preferences.sync.share-favorite-option-title-v2", value: "Share Favorites Across Devices", comment: "Title for the share favorites option in sync settings (V2)")
    static let shareFavoritesOptionCaptionV2 = NotLocalizedString("preferences.sync.share-favorite-option-caption-v2", value: "Use the same favorite bookmarks on mobile and desktop.", comment: "Caption for the share favorites option in sync settings (V2)")
    static let fetchFaviconsOptionTitleV2 = NotLocalizedString("preferences.sync.fetch-favicons-option-title-v2", value: "Load Bookmark Icons", comment: "Title for the load bookmark icons option in sync settings (V2)")
    static let fetchFaviconsOptionCaptionV2 = NotLocalizedString("preferences.sync.fetch-favicons-option-caption-v2", value: "Loads icons from websites you’ve bookmarked. Icon downloads are exposed to your network.", comment: "Caption for the load bookmark icons option in sync settings (V2)")
    static let recoveryCodeSectionTitleV2 = NotLocalizedString("preferences.sync.recovery-code-section-title-v2", value: "Recovery Code", comment: "Recovery code section title in sync settings (V2)")
    static let recoveryInstructionsV2 = NotLocalizedString("preferences.sync.recovery-instructions-v2", value: "Use this code to restore your data if you lose access to this device.", comment: "Instructions on how to restore synced data in sync settings (V2)")
