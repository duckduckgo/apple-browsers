...
public struct UserText {
    ...
    public static let aiChatHeaderNewChatTitle = NSLocalizedString("aichat.header.plusMenu.newChat", value: "New Chat", comment: "Title for the New Chat row in the Duck.ai tab header Plus (+) menu")
