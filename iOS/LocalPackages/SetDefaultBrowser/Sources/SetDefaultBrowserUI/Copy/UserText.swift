...
enum UserText {
    ...
    enum InactiveUserModal {
        ...
        static let continueBrowsingCTA = NSLocalizedString("setDefaultBrowser.inactive-user.cta.secondary.title", bundle: Bundle.module, value: "Maybe Later", comment: "The title of the CTA to dismiss the modal sheet.")
    }
}
