...
final class DataBrokerProtectionStageDurationCalculatorTests: XCTestCase {
    ...
    func testWhenErrorIs404_thenWeFireScanFailedPixel() {
        let sut = DataBrokerProtectionStageDurationCalculator(dataBrokerURL: "broker", dataBrokerVersion: "1.1.1", handler: handler, vpnConnectionState: "disconnected", vpnBypassStatus: "no")
    ...
    func testRecorderReceivesSubmitSuccess() {
        ...
        let sut = DataBrokerProtectionStageDurationCalculator(dataBrokerURL: "broker",
