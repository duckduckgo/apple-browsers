...
export type WebRequestTypeChrome = 'main_frame' | 'sub_frame' | 'stylesheet' | 'script' | 'image' | 'font' | 'object' | 'xmlhttprequest' | 'ping' | 'csp_report' | 'media' | 'websocket' | 'other';
export type WebRequestTypeFirefox = 'main_frame' | 'sub_frame' | 'stylesheet' | 'script' | 'image' | 'object' | 'object_subrequest' | 'xmlhttprequest' | 'xslt' | 'ping' | 'beacon' | 'xml_dtd' | 'font' | 'media' | 'websocket' | 'csp_report' | 'imageset' | 'web_manifest' | 'speculative' | 'other';
...
export default class Request<T = any | undefined> {
     ...
     */
    static fromRawDetails<T = any | undefined>({ requestId, tabId, url, hostname, domain, sourceUrl, sourceHostname, sourceDomain, type, _originalRequestDetails, }: Partial<RequestInitialization<T>>): Request<T>;
    readonly _originalRequestDetails: T;
    type: RequestType;
