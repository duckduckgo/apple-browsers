    ...
    public enum Onboarding {
        ...
        public enum Personalization {
            ...
            public enum AdBlocking {
                ...
                public static let rejectOptionalCookiesTitle = NotLocalizedString("onboarding.personalization.adBlocking.rejectOptionalCookies.title", value: "Manage cookie pop-ups", comment: "Title for the reject-optional-cookies option on the onboarding ad-blocking personalization screen.")
