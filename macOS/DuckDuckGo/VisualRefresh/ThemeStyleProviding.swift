...
struct ThemeStyle: ThemeStyleProviding {
    ...
    private static func buildThemeStyle(name: ThemeName, palette: ThemeColors, featureFlagger: FeatureFlagger) -> ThemeStyle {
        ...
        return ThemeStyle(
            ...
            addressBarStyleProvider: AddressBarStyleProvidingFactory.buildStyleProvider(featureFlagger: featureFlagger, displaysTabsAnimations: displaysTabsAnimations),
