...
public struct UserText {
    ...
    public static let settingsDefaultOmnibarModeFooter = NSLocalizedString("settings.default.omnibar.mode.footer", value: "Default toggle position when opening a new tab.", comment: "Footer text explaining the toggle position setting in AI Features settings")
