...
struct UserText {
    ...
    static let permissionCenterSystemNotificationDisabled = NSLocalizedString("permission.center.system.notification.disabled", value: "To allow notifications, first enable them in\n", comment: "Warning shown when system notifications are disabled but user has allowed the site")
    ...
    static let permissionPopoverSystemNotificationDisabledStandalone = NSLocalizedString("permission.popover.system.notification.disabled.standalone", value: "System notifications disabled. Turn them on in\n", comment: "Warning shown in standalone system-disabled permission view")
