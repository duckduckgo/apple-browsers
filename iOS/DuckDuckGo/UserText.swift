...
public struct UserText {
    ...
    public static let utiDuckAIWarningsLearnMore = NotLocalizedString("aichat.usageWarnings.learnMore", value: "Learn More", comment: "Link at the end of the Duck.ai input footer notice, opening the help page about advanced AI model access")
