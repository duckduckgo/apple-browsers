...
public extension OnboardingTheme {
    ...
    static let iOSRebranding2026 = {
        ...
        let colorPalette = ColorPalette(
            ...
            optionsListBorderColor: Color(designSystemColor: .accentPrimary, palette: .default),
            optionsListIconColor: Color(designSystemColor: .accentPrimary, palette: .default),
            optionsListTextColor: Color(designSystemColor: .accentTextPrimary, palette: .default),
            optionsListHoverColor: Color(designSystemColor: .accentPrimary, palette: .default).opacity(0.1),
            optionsListPressedColor: Color(designSystemColor: .accentPrimary, palette: .default).opacity(0.2),
            primaryButtonBackgroundColor: Color(designSystemColor: .accentBrandPrimary, palette: .default),
            primaryButtonPressedColor: Color(designSystemColor: .accentBrandTertiary, palette: .default),
            primaryButtonTextColor: Color(designSystemColor: .accentBrandContentPrimary, palette: .default),
