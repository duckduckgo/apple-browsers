//
//  PromoServiceFactory+SyncFavicons.swift
//
...
extension PromoServiceFactory {
    ...
    static let syncFaviconsPromoID = "sync-favicons"

    /// Builds the Sync Favicons Promo (migrated from the standalone "Download Missing Icons?" dialog).
    @MainActor
    static func syncFavicons(dependencies: PromoDependencies) -> Promo {
        InternalPromo(
