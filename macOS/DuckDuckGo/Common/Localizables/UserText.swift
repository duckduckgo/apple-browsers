...
struct UserText {
    ...
    static let aiChatTogglePopoverTitle = NSLocalizedString("aichat.toggle.popover.title", value: "NEW! Two private ways to get answers", comment: "Title for the AI Chat toggle introduction popover")
