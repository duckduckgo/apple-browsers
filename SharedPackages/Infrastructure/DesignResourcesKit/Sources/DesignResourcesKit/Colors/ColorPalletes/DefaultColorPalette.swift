...
struct DefaultColorPalette: ColorPaletteDefinition {
    ...
    private static let decorationQuantinary = DynamicColor(lightColor: x1F1F1F.opacity(0.03), darkColor: xF9F9F9.opacity(0.03))
    ...
    static func dynamicColor(for designSystemColor: DesignSystemColor) -> DynamicColor {
        ...
        case .decorationQuantinary: return decorationQuantinary
