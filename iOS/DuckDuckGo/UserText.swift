...
public struct UserText {
    ...
    public static let settingsChatSuggestionsSubtitle = NSLocalizedString("settings.aifeatures.chat.suggestions.subtitle", value: "Show recent Duck.ai chats", comment: "Settings screen cell subtitle for enabling chat suggestions")
