...
public final class DefaultSubscriptionFeatureAvailability: SubscriptionFeatureAvailability {
    ...
    ///   - isSubscriptionRestoreWidePixelMeasurementEnabledProvider: A closure that returns whether the subscriptionRestoreWidePixelMeasurement is supported. Default to false.
