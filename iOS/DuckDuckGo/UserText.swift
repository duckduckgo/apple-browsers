...
public struct UserText {
    ...
    public static let actionAskAIChat = NSLocalizedString("action.title.aiChat.askDuckAI", value: "Ask Duck.ai", comment: "Edit-menu action shown on selected text in the browser; opens Duck.ai with the selection as the prompt")
    ...
    public static let aiChatShareCouldNotLoad = NSLocalizedString("aichat.share.could.not.load", value: "Couldn't load the shared content", comment: "Toast message displayed when content shared into Duck.ai from another app can no longer be read")
