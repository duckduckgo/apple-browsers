...
struct UserText {
    ...
    static let youTubeAdBlockingAnalyticsOptInAlertMessage = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.message", value: "Allow DuckDuckGo to auto-detect video playback issues. This helps to make ad blocking more reliable for everyone.", comment: "Description of the alert shown when the user is enabling YouTube ad blocking")
