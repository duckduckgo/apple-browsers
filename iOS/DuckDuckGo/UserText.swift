...
""", comment: "Ai Chat preferences explanation with a markdown link. Do not translate what's inside [] and ()")
    ...
    public static let dataImportPasswordsInstructionsSafariStep1 = NSLocalizedString("data.import.passwords.instructions.safari.step1", value:"On your %@, open ⚙️ %@.", comment: "Step 1 for instructions to import passwords from Safari. 'On your iPhone, open ⚙️ Settings → Apps → Safari.'")
    public static let dataImportPasswordsInstructionsSafariStep1SystemSettings = NSLocalizedString("data.import.passwords.instructions.safari.step1.system-settings", value:"Settings → Apps → Safari", comment: "second parameter for autofill.import.passwords.instructions.safari.step1")
    ...
    public static let dataImportInstructionsSafariStep2Export = NSLocalizedString("data.import.passwords.instructions.safari.step2.export", value:"Export", comment: "second parameter for autofill.import.instructions.safari.step2")
    public static let dataImportInstructionsSafariStep2Passwords = NSLocalizedString("data.import.passwords.instructions.safari.step2.passwords", value:"Passwords", comment: "third parameter for autofill.import.instructions.safari.step2 if user is importing passwords")
    public static let dataImportInstructionsSafariStep2Bookmarks = NSLocalizedString("data.import.passwords.instructions.safari.step2.passwords", value:"Passwords", comment: "third parameter for autofill.import.instructions.safari.step2 if user is importing bookmarks")

    public static let dataImportPasswordsInstructionsChromeStep1 = NSLocalizedString("data.import.passwords.instructions.chrome.step1", value:"In Chrome, go to %@ and then %@.", comment: "Step 1 for instructions to import passwords from Chrome -> 'In Chrome, go to Google Password Manager and then Settings'")
    public static let dataImportPasswordsInstructionsChromeStep1PasswordManager = NSLocalizedString("data.import.passwords.instructions.chrome.step1.google", value:"Google Password Manager", comment: "first parameter for autofill.import.passwords.instructions.chrome.step1")
    public static let dataImportPasswordsInstructionsChromeStep1Settings = NSLocalizedString("data.import.passwords.instructions.chrome.step1.settings", value:"Settings", comment: "second parameter for autofill.import.passwords.instructions.chrome.step1")

    public static let dataImportPasswordsInstructionsChromeStep2 = NSLocalizedString("data.import.passwords.instructions.chrome.step2", value:"Select %@, then %@ and save the file in a folder that you can remember.", comment: "Step 2 for instructions to import passwords. 'Select Export passwords, then Save to Files and save the file in a folder that you can remember'")
    public static let dataImportPasswordsInstructionsStep2ChromeHistory = NSLocalizedString("data.import.passwords.instructions.chrome.step2.export", value:"Export passwords", comment: "first parameter for autofill.import.passwords.instructions.step2")
    public static let dataImportPasswordsInstructionsStep2ChromeExport = NSLocalizedString("data.import.passwords.instructions.chrome.step2.save", value:"Save to Files", comment: "second parameter for autofill.import.passwords.instructions.step2")
