...
public struct UserText {
    ...
    public static let settingsForceWebsiteDarkMode = NSLocalizedString("settings.force.website.dark.mode", value: "Force Dark Mode on Websites", comment: "Settings screen toggle for forcing dark mode on websites")
