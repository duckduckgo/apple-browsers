...
enum UserText {
    ...
    static let syncWithAnotherDeviceStep3 = NSLocalizedString("preferences.sync.sync-with-another-device.step3", bundle: Bundle.module, value: "**Point your phone at this screen** to scan the QR code", comment: "Third instruction for setting up 'Sync with another device'. **text** markers indicate bold styling, which should be kept around the emphasized phrase.")
