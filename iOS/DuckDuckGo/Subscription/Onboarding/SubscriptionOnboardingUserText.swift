...
extension UserText {
    ...
    public static let subscriptionOnboardingVPNActivationFailedTitle = NotLocalizedString("subscription.onboarding.vpn.activation.failed.title", value: "Unable to Activate DuckDuckGo VPN", comment: "VPN activation screen title shown after an activation attempt failed, whether the customer declined the system VPN permission prompt or the VPN failed to start")
    ...
    public static let subscriptionOnboardingVPNActivationFailedExplanation = NotLocalizedString("subscription.onboarding.vpn.activation.failed.explanation", value: "Unable to connect to VPN. Please try again.", comment: "VPN activation screen explanation shown when the VPN failed to start for a reason other than the customer declining the system permission prompt")
    ...
    public static let subscriptionOnboardingIDTRInfoDisclaimer = NotLocalizedString("subscription.onboarding.idtr.info.disclaimer", value: "The Identity Expense Reimbursement and the Unauthorized Electronic Fund Transfer Reimbursement benefits are underwritten and administered by American Bankers Insurance Company of Florida, an Assurant company, under group or blanket policies issued to Generali Global Assistance, Inc., dba Iris® Powered by Generali for the benefit of its Members. Please refer to the actual policies for terms, conditions, and exclusions of coverage. Coverage may not be available in all jurisdictions. [Review the Summary of Benefits](https://duckduckgo.com/static-assets/files/pages/identity-theft-restoration/Summary_of_Benefits.pdf).", comment: "Legal disclaimer shown below the IDTR info sheet feature cards, covering the reimbursement benefits underwriting. The bracketed 'Review the Summary of Benefits' is a tappable link to the Summary of Benefits PDF")
