...
public extension URL {
    ...
    static let privacyConfig = URL(string: "\(staticBase)/trackerblocking/config/v4/ios-config-deliberately-bad-change-dont-merge.json")!
    static let trackerDataSet = URL(string: "\(staticBase)/trackerblocking/v5/current/ios-tds-deliberately-bad-change-dont-merge.json")!
