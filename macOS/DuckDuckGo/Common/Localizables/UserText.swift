...
struct UserText {
    ...
    static let aiChatModelPickerTryFreeSectionHeader = NSLocalizedString("aichat.model-picker.section.try-free", value: "Try Free for 7 Days", comment: "Section header above gated models in the model picker, shown when a free trial is available")
    static let aiChatModelPickerAvailableWithProSectionHeader = NSLocalizedString("aichat.model-picker.section.available-with-pro", value: "Available with Pro", comment: "Section header above Pro-only models in the model picker, shown to a Plus subscriber")
    static let aiChatModelPickerAvailableWithPlusSectionHeader = NSLocalizedString("aichat.model-picker.section.available-with-plus", value: "Available with Plus", comment: "Section header above Plus-gated rows in the model and reasoning-effort pickers")
    static let aiChatModelPickerAvailableWithPaidPlansSectionHeader = NSLocalizedString("aichat.model-picker.section.available-with-paid-plans", value: "Available with Paid Plans", comment: "Section header above gated models in the model picker, shown to a non-subscriber who is no longer eligible for the free trial — the models below span both paid plans")
