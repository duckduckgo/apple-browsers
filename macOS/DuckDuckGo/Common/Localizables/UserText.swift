...
struct UserText {
    ...
    static let permissionPopupAlwaysDenyButton = NSLocalizedString("permission.popup.always.deny.button", value: "Always Deny", comment: "Button that denies permission and remembers the decision for future requests")
