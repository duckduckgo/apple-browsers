...
final class NewTabPageOmnibarClientTests: XCTestCase {
    ...
    func testSetConfigUpdatesModeAndSettings() async throws {
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: false, showAiSetting: true, showCustomizePopover: true, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: nil, aiModelSections: nil, selectedReasoningEffort: nil)
    ...
    func testWhenSetConfigWithSelectedModelIdThenModelIdIsPersisted() async throws {
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: true, showAiSetting: nil, showCustomizePopover: nil, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: "gpt-4o-mini", aiModelSections: nil, selectedReasoningEffort: nil)
        try await messageHelper.handleMessageExpectingNilResponse(named: .setConfig, parameters: newConfig)
    ...
    func testWhenSetConfigWithSelectedModelIdThenShortNameIsCachedFromModelsProvider() async throws {
        ...
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: true, showAiSetting: nil, showCustomizePopover: nil, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: "maverick", aiModelSections: nil, selectedReasoningEffort: nil)
    ...
    func testWhenSetConfigWithUnknownModelIdThenShortNameIsCleared() async throws {
        ...
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: true, showAiSetting: nil, showCustomizePopover: nil, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: "brand-new-model", aiModelSections: nil, selectedReasoningEffort: nil)
    ...
    func testWhenSetConfigWithValidReasoningEffortThenItIsPersisted() async throws {
        ...
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: true, showAiSetting: nil, showCustomizePopover: nil, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: "reasoning-model", aiModelSections: nil, selectedReasoningEffort: "low")
    ...
    func testWhenSetConfigWithUnsupportedReasoningEffortThenItIsIgnored() async throws {
        ...
        let newConfig = NewTabPageDataModel.OmnibarConfig(mode: .ai, enableAi: true, showAiSetting: nil, showCustomizePopover: nil, enableRecentAiChats: nil, showViewAllAiChats: nil, enableAiChatTools: nil, selectedModelId: "limited-model", aiModelSections: nil, selectedReasoningEffort: "medium")
    ...
    func testSubmitChatIsForwardedToHandler() async throws {
        let expectation = expectation(description: "submitChatCalled")
        (actionHandler as? MockNewTabPageOmnibarActionsHandler)?.submitChatHandler = { chat, target, modelId, images, reasoningEffort in
        ...
        let action = NewTabPageDataModel.SubmitChatAction(chat: "Hello Chat", target: .newWindow, modelId: "gpt-4o-mini", images: [image], reasoningEffort: nil)
        try await messageHelper.handleMessageExpectingNilResponse(named: .submitChat, parameters: action)
        await fulfillment(of: [expectation], timeout: 1)
    }
}
