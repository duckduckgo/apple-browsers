...
public struct UserText {
    ...
    static let simplifiedViewCodeCopyConfirmationTitle = NSLocalizedString("sync.simplified.scan-or-view-code.copy-confirmation.title", bundle: Bundle.module, value: "Don’t close this page", comment: "Title of the reminder shown after the user copies the sync code, telling them to keep the page open.")
    static let simplifiedViewCodeCopyConfirmationMessage = NSLocalizedString("sync.simplified.scan-or-view-code.copy-confirmation.message", bundle: Bundle.module, value: "Open DuckDuckGo on your other device and paste the code.", comment: "Message of the reminder shown after the user copies the sync code.")
