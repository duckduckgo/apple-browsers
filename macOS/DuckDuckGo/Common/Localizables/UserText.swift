...
struct UserText {
    ...
    enum ContextualOnboarding {
        ...
        static let onboardingTryFireButtonTitle = NSLocalizedString("contextual.onboarding.try-fire-button.title", value: "Instantly clear your entire browsing activity in a single quick action with the *Fire Button* whenever you want a fresh start.\n\n%1$@", comment: "Message of a popover on the browser that invites the user to try visiting the browser Fire Button, the parameter is another string (do not remove * and \n\n%1$@")
        static let onboardingTryFireButtonMessage = NSLocalizedString("contextual.onboarding.try-fire-button.message", value: "Give it a try anytime you want a completely fresh start with maximum privacy guaranteed! 🔥", comment: "Message of a popover on the browser that invites the user to try visiting the browser Fire Button.")
        ...
        static let onboardingFirstSearchDoneTitle = NSLocalizedString("contextual.onboarding.first-search-done.title", value: "That’s the DuckDuckGo Search experience you’ve been waiting for!", comment: "After the user performs their first search using the browser, this dialog explains the advantages of using DuckDuckGo")
        static let onboardingFirstSearchDoneMessage = NSLocalizedString("contextual.onboarding.first-search-done.message", value: "Private searches, faster results, fewer intrusive ads, and absolutely no tracking of any personal data that we can prevent.", comment: "After the user performs their first search using the browser, this dialog explains the advantages of using DuckDuckGo")
