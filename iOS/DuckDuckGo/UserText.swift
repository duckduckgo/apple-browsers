...
public struct UserText {
    ...
    public static let scopedFireConfirmationDuckAIExperimentSubtitle = NSLocalizedString("scoped.fire.confirmation.duckai.experiment.subtitle", value: "This chat will be deleted from your device.", comment: "Subtitle for Duck.ai experiment scoped fire confirmation dialog")
